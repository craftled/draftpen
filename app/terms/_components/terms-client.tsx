    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative">
        ...
        <div className="relative pt-24 pb-12 px-4">
          <motion.div className="container max-w-3xl mx-auto space-y-8" variants={container} initial="hidden" animate="show">
            {/* Logo */}
      ...
      <div className="py-16 px-4">
        <div className="container max-w-3xl mx-auto prose dark:prose-invert prose-neutral prose-headings:font-be-vietnam-pro prose-p:text-muted-foreground prose-a:text-foreground prose-a:no-underline hover:prose-a:text-foreground/80 prose-headings:tracking-tight">
          ...
          <p>
            Scira AI offers a single paid subscription: Draftpen Pro with a 7-day free trial. After the trial, it is
            <strong> ${displayUSD}/month</strong>. For current pricing, visit our{' '}
            <Link href="/pricing" className="underline">Pricing page</Link>.
          </p>
          <p>
          ...
          <ul>
            ...
            <li>Your access to Pro features will end at the close of your current billing period</li>
          ...
          <p>
            ...
            <Link href="/privacy-policy" className="underline">Privacy Policy</Link>, which is incorporated into these
          ...
          <p>
            Scira AI is provided "as is" and "as available" without any warranties of any kind, either express or
