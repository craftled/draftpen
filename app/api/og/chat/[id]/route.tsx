...
export async function GET(
  ...
  try {
    ...
    if (!chatWithUser || chatWithUser.visibility !== "public") {
      return new ImageResponse(
        ...
        >
          ...
          >
            <SciraLogo color="#ffffff" height={120} width={120} />
            <div
              style={{
                fontSize: 56,
                color: "#ffffff",
    ...
    const formattedDate = format(
      new Date(chatWithUser.createdAt),
      "MMMM d, yyyy"
    );
    const authorInitial = (chatWithUser.userName || "S")
      .slice(0, 1)
      .toUpperCase();
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              <SciraLogo color="#ffffff" height={28} width={28} />
