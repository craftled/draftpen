  ...
  inputSchema: z
    .object({
      query: z
        .string()
        .describe(
          "The natural language query crafted from the user's arbitrary query"
        ),
      startDate: z
        .string()
        .optional()
        .describe(
          "The start date of the search in the format YYYY-MM-DD (default to 15 days ago if not specified)"
        ),
      endDate: z
        .string()
        .optional()
