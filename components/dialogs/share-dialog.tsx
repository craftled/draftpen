          ...
          {currentVisibility === "private" ? (
            <div className="space-y-3">
              <div className="flex items-center gap-3 rounded-lg border bg-muted/50 p-3">
                <LockIcon className="text-muted-foreground" size={16} />
                <div className="flex-1">
                  <p className="font-medium text-sm">Chat is private</p>
              ...
              <div className="text-center">
                ...
                >
                  {isChangingVisibility ? (
                    ...
                    <>
                      <GlobeHemisphereWestIcon className="mr-2" size={16} />
            ...
            <div className="space-y-4">
              {/* Status */}
              <div className="flex items-center gap-3 rounded-lg border border-blue-200 bg-blue-50 p-3 dark:border-blue-800 dark:bg-blue-950/50">
                <GlobeHemisphereWestIcon
              ...
              <div className="space-y-2">
                <label className="font-medium text-sm">ShareIcon Link</label>
                <div className="flex items-center gap-2 rounded-md border bg-muted/50 p-2">
                  <div className="flex-1 truncate font-mono text-muted-foreground text-xs">
                    {shareUrl}
                  </div>
                  <Button
              ...
              <div className="space-y-2">
                <label className="font-medium text-sm">ShareIcon On</label>
